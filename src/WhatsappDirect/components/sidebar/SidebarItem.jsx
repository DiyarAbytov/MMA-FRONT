...
//   // если диалог битый – вообще ничего не рендерим
...
//       onClick={handleClick}
//     >
//       <img src={unknownAvatar} alt="" className="wa-sidebar__avatar" />

//       <div className="wa-sidebar__item-main">
//         <div className="wa-sidebar__item-header">
//           <div className="wa-sidebar__name">{title}</div>
//           <div
//             className={
//               "wa-sidebar__time" +
//               (hasUnread ? " wa-sidebar__time--unread" : "")
//             }
//           >
//             {time}
//           </div>
...
//         <div className="wa-sidebar__item-bottom">
//           <div className="wa-sidebar__preview">
//             {lastMessage || "\u00a0"}
//           </div>
//           {hasUnread && (
//             <div className="wa-sidebar__badge">
//               {unread > 99 ? "99+" : unread}
//             </div>
//           )}
//         </div>
